...
- [x] After topology is complete, enforce the [350-line Rust file limit](done/enforce-350-line-rust-file-limit.md).
- [x] Complete [architecture and boundary lint hardening](done/harden-architecture-linter-boundaries.md), using the completed topology's package boundaries.
