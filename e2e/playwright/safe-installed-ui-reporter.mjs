...
const STAGE_IDS = new Map([
  ...
  ["owner-global-filter", "owner_global_filter"],
  ["owner-global-launch", "owner_global_launch"],
  ["owner-global-document", "owner_global_document"],
  ["owner-global-cookie", "owner_global_cookie"],
  ["owner-repository-filter", "owner_repository_filter"],
  ["owner-repository-launch", "owner_repository_launch"],
  ["owner-repository-document", "owner_repository_document"],
  ["owner-repository-cookie", "owner_repository_cookie"],
  ...
  ["lifecycle-managed-restart-baseline", "lifecycle_managed_restart_baseline"],
  ["lifecycle-managed-restart-ready", "lifecycle_managed_restart_ready"],
  ["lifecycle-managed-restart-complete", "lifecycle_managed_restart_complete"],
  ["lifecycle-managed-restart-document", "lifecycle_managed_restart_document"],
  ["lifecycle-managed-restart-identity", "lifecycle_managed_restart_identity"],
  ["lifecycle-managed-restart-cookie", "lifecycle_managed_restart_cookie"],
  ["lifecycle-managed-restart-document-response", "lifecycle_managed_restart_document_response"],
  ["lifecycle-managed-restart-identity-response", "lifecycle_managed_restart_identity_response"],
  ["lifecycle-managed-restart-startup-changed", "lifecycle_managed_restart_startup_changed"],
  ["lifecycle-managed-restart-url", "lifecycle_managed_restart_url"],
  ["lifecycle-managed-restart-no-bootstrap", "lifecycle_managed_restart_no_bootstrap"],
  ["lifecycle-managed-restart-verified", "lifecycle_managed_restart_verified"],
  ["lifecycle-managed-restart-audit-verified", "lifecycle_managed_restart_audit_verified"],
  ...
  ["lifecycle-guest-policy-ready", "lifecycle_guest_policy_ready"],
  ["lifecycle-guest-policy-start", "lifecycle_guest_policy_start"],
  ["lifecycle-guest-policy-header-request", "lifecycle_guest_policy_header_request"],
  ["lifecycle-guest-policy-header-status", "lifecycle_guest_policy_header_status"],
  ["lifecycle-guest-policy-header-wire", "lifecycle_guest_policy_header_wire"],
  ["lifecycle-guest-policy-header-json", "lifecycle_guest_policy_header_json"],
  ["lifecycle-guest-policy-set-cookie-response", "lifecycle_guest_policy_set_cookie_response"],
  ["lifecycle-guest-policy-set-cookie-body", "lifecycle_guest_policy_set_cookie_body"],
  ["lifecycle-guest-policy-set-cookie-headers", "lifecycle_guest_policy_set_cookie_headers"],
  ["lifecycle-guest-policy-set-cookie-cookie", "lifecycle_guest_policy_set_cookie_cookie"],
  ["lifecycle-guest-policy-set-cookie-navigation", "lifecycle_guest_policy_set_cookie_navigation"],
  ["lifecycle-guest-policy-location-response", "lifecycle_guest_policy_location_response"],
  ["lifecycle-guest-policy-location-body", "lifecycle_guest_policy_location_body"],
  ["lifecycle-guest-policy-location-headers", "lifecycle_guest_policy_location_headers"],
  ["lifecycle-guest-policy-location-navigation", "lifecycle_guest_policy_location_navigation"],
  ["lifecycle-guest-policy-refresh-response", "lifecycle_guest_policy_refresh_response"],
  ["lifecycle-guest-policy-refresh-body", "lifecycle_guest_policy_refresh_body"],
  ["lifecycle-guest-policy-refresh-headers", "lifecycle_guest_policy_refresh_headers"],
  ["lifecycle-guest-policy-refresh-navigation", "lifecycle_guest_policy_refresh_navigation"],
  ["lifecycle-guest-policy-complete", "lifecycle_guest_policy_complete"],
  ["lifecycle-guest-policy-verified", "lifecycle_guest_policy_verified"],
