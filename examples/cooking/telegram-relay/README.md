...
The fake delivery and ledger commit are one transaction. A real Telegram transport
has **not** been enabled or claimed: implementing it must document ambiguous
outcomes around Telegram's non-idempotent send operation and external raw-token
storage, then undergo the separately authorized real smoke.
