...
if manifest.get("helper_sha256") != hashlib.sha256(js_path.read_bytes()).hexdigest():
    raise SystemExit("vendored release UI kit helper hash does not match its manifest")
...
shutil.copyfile(js_path, output / "dist/heph-ui-kit-v1.0.0.js")
