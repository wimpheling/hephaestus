defmodule HephaestusWebWeb.Router do
  ...
  scope "/", HephaestusWebWeb do
    ...
    live_session :authenticated,
      ...
      live "/projects/:project_id/gateways", ProjectGatewaysLive, :gateways
      live "/projects/:project_id/gateways/:gateway_id", ProjectGatewayLive, :show
      ...
      live "/repositories/:repository_id/commits/:commit", RepositoryCommitDetailLive, :commit
