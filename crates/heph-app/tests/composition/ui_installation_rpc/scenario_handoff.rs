...
use rpc_proto::messages::hephaestus::{
    ...
    release::v1::{CreateUiBrowserHandoffRequest, InstallUiResponse},
};
use sqlx::PgPool;
use uuid::Uuid;
...
pub(super) async fn run(
    ...
    .await;
    super::ui_installation_handoff_validation::assert_empty_idempotency(
        release,
        installed,
        &handoff_token,
    )
...
async fn assert_malformed_wire(
    pool: &PgPool,
    fixture: &Fixture,
    app: &hephaestus_app::RunningHephaestus,
    handoff_token: &str,
