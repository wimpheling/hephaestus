...
const AGENT: &[u8] =
    include_bytes!("../../../../../examples/cooking/cooking-reference-ui/agent.toml");
const UI: &[u8] =
    include_bytes!("../../../../../examples/cooking/cooking-reference-ui/heph.ui.toml");
const HTML: &[u8] =
    include_bytes!("../../../../../examples/cooking/cooking-reference-ui/index.html");
