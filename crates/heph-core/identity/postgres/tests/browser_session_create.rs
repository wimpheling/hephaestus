...
use identity_application::CreateBrowserSessionError;
use identity_domain::{DEFAULT_BROWSER_SESSION_TTL_SECONDS, RequestId, browser_session_sid_digest};
use identity_postgres::PostgresBrowserSessionStore;
use serial_test::serial;
use sqlx::postgres::PgPoolOptions;
use std::fmt::Write as _;
use support::{
    application_pool, insert_expired_session, insert_identity, insert_identity_mapping,
    make_command, worker_pool,
};
use uuid::Uuid;

#[path = "browser_session_create/support.rs"]
mod support;
