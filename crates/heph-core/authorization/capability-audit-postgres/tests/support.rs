//! `PostgreSQL` capability-audit fixture setup.
use authz_postgres::AUTHORIZATION_MODEL_VERSION;
use capability_audit::{CapabilityAuditContext, CapabilityDecision, NewCapabilityAuditEvent};
...
// Keep the end-to-end relational fixture together so its insert order mirrors the authorization graph.
