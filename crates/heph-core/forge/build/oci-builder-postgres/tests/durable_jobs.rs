...
const MIGRATION: &str =
    include_str!("../../../../../../migrations/0017_repository_oci_image_jobs.sql");
const PREPARATION_HISTORY_FIX: &str = include_str!(
    "../../../../../../migrations/0051_fix_repository_oci_image_preparation_event_outcome.sql"
);
const PREPARATION_EVENT_GRANT: &str = include_str!(
    "../../../../../../migrations/0052_grant_repository_oci_preparation_event_trigger_insert.sql"
);
const DEFINITION_TRIGGER_READ_GRANT: &str = include_str!(
    "../../../../../../migrations/0053_grant_repository_oci_definition_trigger_read.sql"
);
