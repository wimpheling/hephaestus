...
impl PgBuildRepository {
    ...
    ///
    /// Returns a storage or provider-state error when persistence fails.
    pub async fn mark_running_impl(&self, id: BuildRequestId) -> Result<(), BuildRepositoryError> {
    ...
    ///
    /// Returns a storage or provider-state error when persistence fails.
    pub async fn mark_imported_impl(
        &self,
        id: BuildRequestId,
        artifacts: &[Value],
    ) -> Result<(), BuildRepositoryError> {
    ...
    ///
    /// Returns a storage or provider-state error when persistence fails.
    pub async fn mark_drafted_impl(&self, id: BuildRequestId) -> Result<(), BuildRepositoryError> {
