...
mod tests {
    use super::{
        AuthenticatedHumanGitEndpoint, AuthorizationRequest, BackendEnvironment, GitAuthenticator,
        GitAuthorizer, GitOperation, OidcGitAuthenticator, PostgresGitAuthorizer, Principal,
        authentication_error_response, backend_command, diff_refs, parse_basic_pat,
        parse_cgi_headers, pat_operation, validate_backend_path,
    };
    use async_trait::async_trait;
    use authz_domain::{
