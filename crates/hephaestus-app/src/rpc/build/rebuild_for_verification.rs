...
use rpc_proto::messages::hephaestus::{
    build::v1::{RebuildForVerificationRequest, RebuildForVerificationResponse},
    common::v1::Operation,
};
use uuid::Uuid;

const AUDIENCE: &str = "/hephaestus.build.v1.BuildService/RebuildForVerification";

pub(super) async fn handle(
    service: &super::BuildRpc,
    ctx: RequestContext,
    request_message: ServiceRequest<'_, RebuildForVerificationRequest>,
) -> ServiceResult<RebuildForVerificationResponse> {
