pub(super) async fn handle(
    ...
    use crate::application::build::{BuildPage, decode_cursor, encode_cursor};
    use rpc_proto::messages::hephaestus::{
        build::v1::ListBuildsResponse, common::v1::PageResponse,
    };
    use uuid::Uuid;

    use super::super::{RpcError, into_connect_error, request as shared_request};

    const AUDIENCE: &str = "/hephaestus.build.v1.BuildService/ListBuilds";
