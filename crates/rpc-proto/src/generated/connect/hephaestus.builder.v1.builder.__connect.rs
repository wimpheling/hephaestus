...
pub type OwnedListProjectBuildersRequestView = ::buffa::view::OwnedView<
    ...
    >,
>;
///Shorthand for `OwnedView<ListProjectBuildersResponseView<'static>>`.
pub type OwnedListProjectBuildersResponseView = ::buffa::view::OwnedView<
    crate::messages::hephaestus::builder::v1::__buffa::view::ListProjectBuildersResponseView<
        'static,
    >,
>;
///Shorthand for `OwnedView<GetProjectBuilderRequestView<'static>>`.
pub type OwnedGetProjectBuilderRequestView = ::buffa::view::OwnedView<
    crate::messages::hephaestus::builder::v1::__buffa::view::GetProjectBuilderRequestView<
        'static,
    >,
>;
...
>
for crate::messages::hephaestus::builder::v1::__buffa::view::GetProjectBuilderResponseView<
    '_,
> {
    fn encode(
        &self,
...
/// The dispatcher surfaces this on
/// [`RequestContext::spec`](::connectrpc::RequestContext::spec).
pub const BUILDER_CATALOG_SERVICE_LIST_PROJECT_BUILDERS_SPEC: ::connectrpc::Spec = ::connectrpc::Spec::server(
        "/hephaestus.builder.v1.BuilderCatalogService/ListProjectBuilders",
        ::connectrpc::StreamType::Unary,
    )
    .with_idempotency_level(::connectrpc::IdempotencyLevel::NoSideEffects);
/// Static [`Spec`](::connectrpc::Spec) for the server-side `GetProjectBuilder` RPC.
///
/// The dispatcher surfaces this on
/// [`RequestContext::spec`](::connectrpc::RequestContext::spec).
pub const BUILDER_CATALOG_SERVICE_GET_PROJECT_BUILDER_SPEC: ::connectrpc::Spec = ::connectrpc::Spec::server(
...
pub trait BuilderCatalogService: Send + Sync + 'static {
    ...
    /// `.to_owned_message()` (or copy the specific fields) for anything
    /// returned, stored, or moved into `tokio::spawn`.
    fn list_project_builders<'a>(
        &'a self,
        ctx: ::connectrpc::RequestContext,
        request: ::connectrpc::ServiceRequest<
            '_,
            crate::messages::hephaestus::builder::v1::ListProjectBuildersRequest,
        >,
    ) -> impl ::std::future::Future<
        Output = ::connectrpc::ServiceResult<
            impl ::connectrpc::Encodable<
        ...
        >,
    > + Send;
    /// Handle the GetProjectBuilder RPC.
    ///
    /// `'a` lets the response body borrow from `&self` (e.g. server-resident state).
    ///
    /// `request` is borrowed from the request body and is valid for the
    ...
    /// `.to_owned_message()` (or copy the specific fields) for anything
    /// returned, stored, or moved into `tokio::spawn`.
    fn get_project_builder<'a>(
        &'a self,
        ctx: ::connectrpc::RequestContext,
        request: ::connectrpc::ServiceRequest<
            '_,
            crate::messages::hephaestus::builder::v1::GetProjectBuilderRequest,
        >,
    ) -> impl ::std::future::Future<
        Output = ::connectrpc::ServiceResult<
            impl ::connectrpc::Encodable<
...
impl<S: BuilderCatalogService> BuilderCatalogServiceExt for S {
    fn register(
        ...
        router
                        ...
                        format|
                    {
                        ...
                        async move {
                            let sreq = ::connectrpc::ServiceRequest::<
                                crate::messages::hephaestus::builder::v1::ListProjectBuildersRequest,
                            >::from_parts(req.reborrow(), req.bytes());
                            svc.list_project_builders(ctx, sreq)
                                .await?
                                .encode::<
                                    crate::messages::hephaestus::builder::v1::ListProjectBuildersResponse,
                                >(format)
            ...
            .with_spec(BUILDER_CATALOG_SERVICE_LIST_PROJECT_BUILDERS_SPEC)
            .route_view_idempotent(
                BUILDER_CATALOG_SERVICE_SERVICE_NAME,
                "GetProjectBuilder",
                {
                        ...
                        format|
                    {
                        ...
                        async move {
                            let sreq = ::connectrpc::ServiceRequest::<
                                crate::messages::hephaestus::builder::v1::GetProjectBuilderRequest,
                            >::from_parts(req.reborrow(), req.bytes());
                            svc.get_project_builder(ctx, sreq)
                                .await?
                                .encode::<
                                    crate::messages::hephaestus::builder::v1::GetProjectBuilderResponse,
                                >(format)
            ...
            "ListProjectBuilders" => {
                ...
                Box::pin(async move {
                    let body = ::connectrpc::dispatcher::codegen::request_proto_bytes::<
                        crate::messages::hephaestus::builder::v1::ListProjectBuildersRequest,
                    >(request.encoded()?, format)?;
                    let req: crate::messages::hephaestus::builder::v1::__buffa::view::ListProjectBuildersRequestView<
                        '_,
                    > = ::connectrpc::dispatcher::codegen::decode_borrowed_request_view(
                        &body,
                    )?;
                    let req = ::connectrpc::ServiceRequest::<
                        crate::messages::hephaestus::builder::v1::ListProjectBuildersRequest,
                    >::from_parts(&req, &body);
                    svc.list_project_builders(ctx, req)
                        .await?
                        .encode::<
                            crate::messages::hephaestus::builder::v1::ListProjectBuildersResponse,
                        >(format)
            ...
            "GetProjectBuilder" => {
                ...
                Box::pin(async move {
                    let body = ::connectrpc::dispatcher::codegen::request_proto_bytes::<
                        crate::messages::hephaestus::builder::v1::GetProjectBuilderRequest,
                    >(request.encoded()?, format)?;
                    let req: crate::messages::hephaestus::builder::v1::__buffa::view::GetProjectBuilderRequestView<
                        '_,
                    > = ::connectrpc::dispatcher::codegen::decode_borrowed_request_view(
                        &body,
                    )?;
                    let req = ::connectrpc::ServiceRequest::<
                        crate::messages::hephaestus::builder::v1::GetProjectBuilderRequest,
                    >::from_parts(&req, &body);
                    svc.get_project_builder(ctx, req)
                        .await?
                        .encode::<
                            crate::messages::hephaestus::builder::v1::GetProjectBuilderResponse,
                        >(format)
    ...
    <T::ResponseBody as ::connectrpc::http_body::Body>::Error: ::std::fmt::Display,
{
    ...
    pub async fn list_project_builders(
        &self,
        request: crate::messages::hephaestus::builder::v1::ListProjectBuildersRequest,
    ) -> Result<
        ::connectrpc::client::UnaryResponse<
            ::buffa::view::OwnedView<
                crate::messages::hephaestus::builder::v1::__buffa::view::ListProjectBuildersResponseView<
        ...
        ::connectrpc::ConnectError,
    > {
        self.list_project_builders_with_options(
                request,
                ::connectrpc::client::CallOptions::default(),
            )
            .await
    }
    /// Call the ListProjectBuilders RPC with explicit per-call options. Options override [`ClientConfig`](::connectrpc::client::ClientConfig) defaults.
    pub async fn list_project_builders_with_options(
        &self,
        request: crate::messages::hephaestus::builder::v1::ListProjectBuildersRequest,
        options: ::connectrpc::client::CallOptions,
    ) -> Result<
    ...
    /// Call the GetProjectBuilder RPC. Sends a request to /hephaestus.builder.v1.BuilderCatalogService/GetProjectBuilder.
    pub async fn get_project_builder(
        &self,
        request: crate::messages::hephaestus::builder::v1::GetProjectBuilderRequest,
    ) -> Result<
        ::connectrpc::client::UnaryResponse<
            ::buffa::view::OwnedView<
                crate::messages::hephaestus::builder::v1::__buffa::view::GetProjectBuilderResponseView<
        ...
        ::connectrpc::ConnectError,
    > {
        self.get_project_builder_with_options(
                request,
                ::connectrpc::client::CallOptions::default(),
            )
            .await
    }
    /// Call the GetProjectBuilder RPC with explicit per-call options. Options override [`ClientConfig`](::connectrpc::client::ClientConfig) defaults.
    pub async fn get_project_builder_with_options(
        &self,
        request: crate::messages::hephaestus::builder::v1::GetProjectBuilderRequest,
        options: ::connectrpc::client::CallOptions,
    ) -> Result<
