...
class RunnerImageBuildTests(unittest.TestCase):
    ...
    def test_workflow_keeps_image_build_manual_and_cleanup_separate(self):
        ...
        self.assertIn("options: [preflight, image-build, image-retire, cache-preflight, diagnostics-triage, diagnostic, smoke, gcp-cooking, provider-metrics, cooking]", workflow)
