...
mkdir -p "${scratch}/crates/heph-core/platform/rpc-proto/src/generated" \
...
diff --recursive --unified --new-file \
  "${repository_root}/crates/heph-core/platform/rpc-proto/src/generated" \
  "${scratch}/crates/heph-core/platform/rpc-proto/src/generated"
diff --recursive --unified --new-file \
