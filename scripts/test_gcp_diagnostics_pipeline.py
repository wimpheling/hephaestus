    ...
    def test_panic_reason_is_closed_and_credential_panic_is_quarantined_with_first_failure(self):
        ...
        with tempfile.TemporaryDirectory(prefix="heph-gcp-panic-projection-") as directory:
            ...
            safe_runtime.write_text(
                ...
                "provision prepared service worker VM: Unavailable {\n"
                " resource: \"worker binary\",\n"
                " reason: \"Permission denied\",\n"
                "}\n"
                "thread 'prepared-worker' panicked at crates/foo/src/worker.rs:821:7\n"
                "provision prepared service worker VM: Unavailable { resource: \"worker-configuration\", reason: \"worker I/O failed: Permission denied (os error 13)\" }\n"
                "thread 'prepared-worker' panicked at crates/foo/src/provider.rs:1184:7\n"
                ...
                "thread 'prepared-worker' panicked at crates/foo/src/provider.rs:1057:9\n"
            ...
            self.assertEqual(
                ...
                "error_class=permission-denied errno=EACCES\n"
                "HEPH_GCP_TEST test=rust-panic location=crates/foo/src/worker.rs:821:7\n"
                "HEPH_GCP_TEST test=rust-panic operation=worker-configuration "
                "error_class=permission-denied errno=EACCES\n"
                "HEPH_GCP_TEST test=rust-panic location=crates/foo/src/provider.rs:1184:7\n"
                ...
                "error_class=permission-denied errno=EACCES\n"
                "HEPH_GCP_TEST test=rust-panic location=crates/foo/src/provider.rs:1057:9\n"
